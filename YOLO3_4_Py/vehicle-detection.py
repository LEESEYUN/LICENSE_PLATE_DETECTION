...
if __name__ == '__main__':
	...
	try:
		...
		vehicle_weights = bytes('weights/yolov3.weights',encoding="utf-8")
		vehicle_netcfg  = bytes('cfg/yolov3.cfg',encoding="utf-8")
		vehicle_dataset = bytes('cfg/coco.data',encoding="utf-8")
